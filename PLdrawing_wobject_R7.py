...
class Editor(tkinter.Frame):
    ...
    def drawing_rcvr_leftMouseRelease(self, event):
        ...
        random_8bit_color = utils.random_8bit_color()
...
class Pane_Toolbox(tkinter.Frame):
    ...
    def update_grid(self):
        ...
        for grid_rcvr in grid_receiver_list:
            ...
            self.parent.editor.canvas.create_text((x, y), tag="grid_level", text=str(consider_level), font=DRAWING_FONT, fill=textcolor)
